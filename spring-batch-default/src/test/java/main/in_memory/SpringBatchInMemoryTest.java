...
@ContextConfiguration(locations = {"classpath:in-memory/application-context.xml"})
public class SpringBatchInMemoryTest {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchInMemoryTest.class);
