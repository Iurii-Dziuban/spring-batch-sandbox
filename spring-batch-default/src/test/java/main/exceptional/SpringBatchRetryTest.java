...
@ContextConfiguration(locations = {"classpath:exceptional/retry-application-context.xml"})
public class SpringBatchRetryTest {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchRetryTest.class);
