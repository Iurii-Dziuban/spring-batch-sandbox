...
@ContextConfiguration(locations = {"classpath:concurrent/parallel-application-context.xml"})
public class SpringBatchParallelTest {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchParallelTest.class);
