...
@ContextConfiguration(locations = {"classpath:mybatis/application-context-mapper.xml"})
public class SpringBatchMyBatisMapperTest {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchMyBatisMapperTest.class);
