...
@ContextConfiguration(locations = {"classpath:hibernate/application-context.xml"})
public class SpringBatchHibernateTest {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchHibernateTest.class);
