...
@ContextConfiguration(locations = {"classpath:jpa/application-context-openjpa.xml"})
public class SpringBatchJpaOpenJpaTest {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchJpaOpenJpaTest.class);
