...
import org.springframework.batch.item.database.orm.Hibernate5QueryProvider;
 ...
 * via {@link #setQueryProvider(Hibernate5QueryProvider)}.
 *
 *
 * <p>
 ...
 * @author Dave Syer
 */
public class Hibernate5CursorItemReader<T> extends AbstractItemCountingItemStreamItemReader<T>
        implements InitializingBean {

    private Hibernate5ItemReaderHelper<T> helper = new Hibernate5ItemReaderHelper<T>();

    public Hibernate5CursorItemReader() {
     ...
     * {@link #setQueryProvider(Hibernate5QueryProvider) query provider} should
     * be set.
     *
     ...
     */
    public void setQueryProvider(Hibernate5QueryProvider queryProvider) {
        helper.setQueryProvider(queryProvider);
    }

    /**
     * A query string in HQL. Either this or the {
     * {@link #setQueryProvider(Hibernate5QueryProvider) query provider} or the {
