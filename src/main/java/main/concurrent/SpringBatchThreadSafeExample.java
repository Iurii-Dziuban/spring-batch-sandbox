 ...
 */
public class SpringBatchThreadSafeExample {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchComplexRetryExample.class);

    public static void main( String[] args ) throws Exception {

        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext(new String[]{"classpath:concurrent/thread-safe-application-context.xml"});
