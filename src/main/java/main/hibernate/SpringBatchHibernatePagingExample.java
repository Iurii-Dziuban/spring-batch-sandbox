 ...
 */
public class SpringBatchHibernatePagingExample {

    private static final Log LOGGER = LogFactory.getLog(SpringBatchHibernatePagingExample.class);

    public static void main( String[] args ) throws Exception {

        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext(new String[]{"classpath:hibernate/application-context-paging.xml"});
